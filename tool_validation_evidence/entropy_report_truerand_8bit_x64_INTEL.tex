...
\date{2023-Nov-04 09:13:45.514738}
\begin{document}
\StopCensoring
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hline 
Path to the acquisition data & \verb|"D:\usr\SP800-90B_EntropyAssessment-master\bin\truerand_8bit.bin"| \\
\hline
...
\\
\hline
Last write time & 2021-Sep-20 10:22:46 \\
\hline
\end{tabular}
\end{center}
\end{table}
