...
\date{2023-Jul-29 17:59:31.847210}
\begin{document}
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%
...
\hline 
Path to the acquisition data & \verb|"C:\usr\01_git_repos\NIST_SP800-90B_EntropyAssessment\SP800-90B_EntropyAssessment\bin\normal.bin"| \\
\hline
...
\hline \hline 
The intial entropy source estimate [bit / 8 - bit]	& \multicolumn{2}{|c|}{4.1001}	\\
