...
\date{2023-Jul-29 17:03:40.808680}
\begin{document}
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%
...
\hline 
Path to the acquisition data & \verb|"C:\usr\01_git_repos\NIST_SP800-90B_EntropyAssessment\SP800-90B_EntropyAssessment\bin\truerand_1bit.bin"| \\
\hline
...
\\
\hline
Last write time & 2023-Jun-30 21:13:47 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\,												& [bit / 1 - bit]		\\
\hline 
The Most Common Value Estimate					& 0.995043\\
\hline 
The Collision Estimate							& 0.900935\\
\hline 
The Markov Estimate								& 0.998486\\
\hline 
The Compression Estimate						& 0.829677\\
\hline 
The t-Tuple Estimate							& 0.914226\\
\hline 
The Longest Repeated Substring (LRS) Estimate	& 0.985818\\
\hline 
Multi Most Common in Window Prediction Estimate	& 0.996972\\
\hline 
The Lag Prediction Estimate						& 0.998292\\
\hline 
The MultiMMC Prediction Estimate				& 0.99666\\
\hline 
The LZ78Y Prediction Estimate					& 0.99705\\
\hline \hline 
The intial entropy source estimate [bit / 1 -bit]	& 0.829677	\\
