...
\date{2023-Jul-29 16:58:40.350142}
\begin{document}
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%
...
\hline 
Path to the acquisition data & \verb|"C:\usr\01_git_repos\NIST_SP800-90B_EntropyAssessment\SP800-90B_EntropyAssessment\bin\rand1_short.bin"| \\
\hline
...
\,												& [bit / 1 - bit]		\\
\hline 
The Most Common Value Estimate					& 0.961059\\
\hline 
The Collision Estimate							& 0.691464\\
\hline 
The Markov Estimate								& 0.987596\\
\hline 
The Compression Estimate						& 0.611716\\
\hline 
The t-Tuple Estimate							& 0.867624\\
\hline 
The Longest Repeated Substring (LRS) Estimate	& 0.962626\\
\hline 
Multi Most Common in Window Prediction Estimate	& 0.952618\\
\hline 
The Lag Prediction Estimate						& 0.943334\\
\hline 
The MultiMMC Prediction Estimate				& 0.961617\\
\hline 
The LZ78Y Prediction Estimate					& 0.961446\\
\hline \hline 
The intial entropy source estimate [bit / 1 -bit]	& 0.611716	\\
