...
\date{2023-Jul-29 17:28:28.924092}
\begin{document}
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%
...
\hline 
Path to the acquisition data & \verb|"C:\usr\01_git_repos\NIST_SP800-90B_EntropyAssessment\SP800-90B_EntropyAssessment\bin\truerand_4bit.bin"| \\
\hline
...
\hline \hline 
The intial entropy source estimate [bit / 4 - bit]	& \multicolumn{2}{|c|}{3.60251}	\\
$H_{I} = \min (H_{\textrm{original}}, 4\times H_{\textrm{bitstring}})$ &\multicolumn{2}{ | c | } {\, }	\\
\hline \hline 
