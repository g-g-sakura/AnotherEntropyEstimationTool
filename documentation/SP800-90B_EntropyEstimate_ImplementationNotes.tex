...
the following rough phase diagram would be obtained, by taking the horizontal axis as $\log \frac{t_{00}}{t_{11}}$, and the vertical axis $\tfrac{1}{2}\log \frac{t_{01} t_{10}}{t_{11}^{2}}$.
...
\begin{tikzpicture}
	...
	\draw (5, 0) node {$\log \frac{t_{00}}{t_{11}}$} ;
	\draw (0, 4.8) node {$\tfrac{1}{2} \ln \frac{t_{01} t_{10}}{t_{11}^{2}}$} ;
	\draw (0, 0) -- (4, 4);
	\draw (4, 4.2) node {$\tfrac{1}{2} \ln \frac{t_{01} t_{10}}{t_{11}^{2}} = \log \frac{t_{00}}{t_{11}}$} ;
	%%%%%
